...
try:
    ...
    config_sample = os.path.join(os.path.dirname(__file__), 'config/config_sample.json')
    config_data = {}
    ...
    env_vars = {
        ...
        "cloudflare_zone_id": ((os.environ.get('cloudflare_zone_id')).split(", ") if os.environ.get('cloudflare_zone_id') else None),
        "cloudflare_api_token": ((os.environ.get('cloudflare_api_token')).split(", ") if os.environ.get('cloudflare_api_token') else None),
