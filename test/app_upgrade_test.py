...
from app.services.upgrader.upgrade import upgrade
from app.models.deployment import Deployment

new_helm_deployment = Deployment(
    app="gitlab",
    name="gitlab-helm",
...
new_docker_deployment = Deployment(
    app="immich",
    name="immich-server",
    argo_app="immich",
    status="Running",
...
new_docker_2_deployment = Deployment(
    app="vaultwarden",
    name="deployment-app",
...
new_docker_3_deployment = Deployment(
    app="minio",
    name="deployment",
    argo_app="minio",
    status="Running",
    ...
    latest_version="RELEASE.2024-12-18T13-15-44Z",
    target_version="latest",
    hold_flag=False,
    auto_update=True,
    auto_upgrade=True,
...
upgrade(new_helm_deployment)
upgrade(new_docker_deployment)
upgrade(new_docker_2_deployment)
upgrade(new_docker_3_deployment)
